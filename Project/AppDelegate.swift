...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //Set color for navigation bar & tool bar
        
        UINavigationBar.appearance().barTintColor = UIColor.orangeColor()
        
        UIToolbar.appearance().backgroundColor = UIColor.orangeColor()
...
//      NSUserDefaults.standardUserDefaults().synchronize()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.yukti.Project" in the application's documents Application Support directory.
